...
import { Camera, Plus, Minus, RefreshCw } from 'lucide-react';
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            try {
                ...
                if (prod.Inventory) {
                    setManageStock(true);
                    setStockQuantity(prod.Inventory.quantity || 0);
                    setLowStockAlert(prod.Inventory.low_stock_threshold || 5);
                }
            } catch (err) {
        ...
        <div className="container mx-auto max-w-[1400px]">
            ...
            <nav className="flex text-sm text-[#6c757d] mb-4">
                <ol className="flex items-center space-x-2">
                    ...
                    <li className="text-[#6c757d] before:content-['/'] before:mx-2">Edit Product</li>
                </ol>
            </nav>
                    ...
                    <div className="w-full lg:w-7/12">
                        <div className="bg-white rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-[#0000001a] overflow-hidden">
                            ...
                            <div className="p-6">
                                <div className="flex flex-col md:flex-row gap-6">
                                    ...
                                    <div className="w-full md:w-1/3">
                                        <div className="flex flex-col">
                                            ...
                                            <label className="flex items-center justify-center gap-1 w-full bg-white border border-[#d4af37] text-[#d4af37] hover:bg-[#d4af37] hover:text-white px-3 py-1.5 rounded-lg text-sm font-medium transition-colors cursor-pointer shadow-sm">
                                    ...
                                    <div className="w-full md:w-2/3">
                                        <div className="mb-4">
                                            ...
                                            <input type="text" name="product_name" value={formData.product_name} onChange={handleChange} required className="w-full px-3 py-2 bg-white border border-[#ced4da] rounded-lg text-[#212529] focus:outline-none focus:ring-2 focus:ring-[#d4af37] transition-all" />
                                        </div>

                                        <div className="mb-4">
                                            <label className="block text-sm font-medium text-[#212529] mb-1">SKU (Stock Keeping Unit) <span className="text-[#dc3545]">*</span></label>
                                            <input type="text" name="sku" value={formData.sku} onChange={handleChange} required className="w-full px-3 py-2 bg-white border border-[#ced4da] rounded-lg text-[#212529] focus:outline-none focus:ring-2 focus:ring-[#d4af37] transition-all" />
                                        </div>
                                        ...
                                        <div className="flex gap-4">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="flex border border-[#ced4da] rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-[#d4af37] transition-all">
                                                    ...
                                                    <input type="number" name="price" value={formData.price} onChange={handleChange} required className="flex-1 px-3 py-2 bg-white text-[#212529] focus:outline-none" step="0.01" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="mt-6">
                                    <label className="block text-sm font-medium text-[#212529] mb-1">Product Description</label>
                                    <textarea name="description" value={formData.description} onChange={handleChange} required rows="4" className="w-full px-3 py-2 bg-white border border-[#ced4da] rounded-lg text-[#212529] focus:outline-none focus:ring-2 focus:ring-[#d4af37] transition-all resize-y"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="p-6">
                                ...
                                {manageStock && (
                                    <div className="space-y-4 mb-6">
                                        <div>
                                            <label className="block text-sm font-medium text-[#212529] mb-1">Current Stock</label>
                                            <input type="text" value={stockQuantity} disabled className="w-full px-3 py-2 bg-[#e9ecef] border border-[#ced4da] rounded-lg text-[#212529] mb-1" />
                                            <p className="text-xs text-[#6c757d]">To change stock, use the <Link to="/inventory/restock" className="text-[#d4af37] hover:underline">Restock</Link> feature</p>
                                        </div>
